      ...
      {!confirmSignOut ? (
        ...
        <div className="rounded-2xl border border-error-500/30 bg-error-500/8 px-5 py-4">
          ...
          <div className="flex gap-3">
            <button onClick={handleSignOut} className="px-4 py-2 rounded-xl bg-error-500 hover:bg-error-600 text-white text-sm font-semibold transition-colors">
              Tak, wyloguj
            </button>
            <button onClick={() => setConfirmSignOut(false)} className="px-4 py-2 rounded-xl border border-white/[0.08] text-sm font-medium text-gray-300 hover:text-white hover:bg-white/[0.04] transition-colors">
              Anuluj
            </button>
          </div>
        </div>
